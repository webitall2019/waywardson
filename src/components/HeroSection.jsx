        ...
        <>
            <div className="overflow-hidden" id="home">
                <div
                    ...
                    id="home"
                >
                    <AnimationOnScroll animateIn="animate__fadeIn" offset={10}>
                        ...
                        <p className="inline text-lg lg:text-xl text-text-white-contrast sm:block lg:text-[20px] lg:leading-[28px] w-3/5 mx-auto ">
                            Wayward Son delivers a greasy, gritty, soulful
                            sound, blending country & southern rock music and
                            giving it a massive kick in the pants! So bring
                            their high-energy Southern Rock show to your town &
